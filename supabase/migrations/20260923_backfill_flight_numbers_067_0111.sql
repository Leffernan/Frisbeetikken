-- Flight numbers for products 067-0111.
...
-- https://www.discmania.net/collections/rainmaker
-- https://www.discmania.net/products/d-line-p2
-- https://www.discmania.net/products/soft-exo-link
-- https://www.dynamicdiscs.com/collections/dynamic-discs-judge
-- https://www.kastaplast.com/collections/putt-approach
...
where id ~ '^[0-9]+$'
  and id::integer between 67 and 111
order by id::integer;
